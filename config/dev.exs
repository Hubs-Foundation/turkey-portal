...
auth_pub_key =
  case pub_key_choice do
    :staging ->
      # Public key for verifying tokens generated by the staging auth server.
    ...
    :dev ->
      # Public key for verifying tokens generated by the prtl.generate_dev_token mix task.
      "-----BEGIN RSA PUBLIC KEY-----\n" <>
...
config :prtl, PrtlWeb.Plugs.Auth, auth_pub_key: auth_pub_key
